...
- 6137d5b: fix: harden import map generation and module resolution
...
- 30b6057: fix: compute integrity hashes after Vite dynamic-import rewrites
...
- c206e3c: fix: support local entries referenced by absolute paths
